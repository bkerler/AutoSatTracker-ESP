...
function t(a,b){a.prototype=ba(b.prototype);a.prototype.constructor=a;if(ha)ha(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.K=b.prototype}
...
var f=new c;b.prototype.C=function(g){var h=this.i();g.X(h.resolve,h.reject)};
b.prototype.D=function(g,h){var k=this.i();try{g.call(h,k.resolve,k.reject)}catch(l){k.reject(l)}};
b.prototype.then=function(g,h){function k(v,p){return"function"==typeof v?function(D){try{l(v(D))}catch(J){n(J)}}:p}
...
b.all=function(g){var h=q(g),k=h.next();return k.done?d([]):new b(function(l,n){function r(D){return function(J){v[D]=J;p--;0==p&&l(v)}}
...
eb.prototype.I=!0;eb.prototype.H=function(){return this.f};
eb.prototype.toString=function(){return"Const{"+this.f+"}"};
var gb={},fb={},hb;hb=new eb(fb,"");function ib(){this.f="";this.g=jb}
ib.prototype.I=!0;ib.prototype.H=function(){return this.f.toString()};
...
H.prototype.I=!0;H.prototype.H=function(){return this.f.toString()};
...
var xb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;function yb(a){if(a instanceof H)return a;a="object"==typeof a&&a.I?a.H():String(a);xb.test(a)||(a="about:invalid#zClosurez");return zb(a)}
...
Db.prototype.I=!0;Db.prototype.H=function(){return this.f.toString()};
...
function bc(a,b){Ua(b,function(c,d){c&&"object"==typeof c&&c.I&&(c=c.H());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:cc.hasOwnProperty(d)?a.setAttribute(cc[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
return a}
var qc={Ya:"allow-forms",Za:"allow-modals",ab:"allow-orientation-lock",bb:"allow-pointer-lock",cb:"allow-popups",eb:"allow-popups-to-escape-sandbox",fb:"allow-presentation",gb:"allow-same-origin",hb:"allow-scripts",ib:"allow-top-navigation",jb:"allow-top-navigation-by-user-activation"},sc=Ta(function(){return rc()});
...
function b(r){for(var v=g,p=0;64>p;p+=4)v[p/4]=r[p]<<24|r[p+1]<<16|r[p+2]<<8|r[p+3];for(p=16;80>p;p++)r=v[p-3]^v[p-8]^v[p-14]^v[p-16],v[p]=(r<<1|r>>>31)&4294967295;r=e[0];var D=e[1],J=e[2],qa=e[3],uc=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var Ka=qa^D&(J^qa);var Gb=1518500249}else Ka=D^J^qa,Gb=1859775393;else 60>p?(Ka=D&J|qa&(D|J),Gb=2400959708):(Ka=D^J^qa,Gb=3395469782);Ka=((r<<5|r>>>27)&4294967295)+Ka+uc+Gb+v[p]&4294967295;uc=qa;qa=J;J=(D<<30|D>>>2)&4294967295;D=r;r=Ka}e[0]=e[0]+r&4294967295;e[1]=
e[1]+D&4294967295;e[2]=e[2]+J&4294967295;e[3]=e[3]+qa&4294967295;e[4]=e[4]+uc&4294967295}
function c(r,v){if("string"===typeof r){r=unescape(encodeURIComponent(r));for(var p=[],D=0,J=r.length;D<J;++D)p.push(r.charCodeAt(D));r=p}v||(v=r.length);p=0;if(0==l)for(;p+64<v;)b(r.slice(p,p+64)),p+=64,n+=64;for(;p<v;)if(f[l++]=r[p++],n++,64==l)for(l=0,b(f);p+64<v;)b(r.slice(p,p+64)),p+=64,n+=64}
function d(){var r=[],v=8*n;56>l?c(h,56-l):c(h,64-(l-56));for(var p=63;56<=p;p--)f[p]=v&255,v>>>=8;b(f);for(p=v=0;5>p;p++)for(var D=24;0<=D;D-=8)r[v++]=e[p]>>D&255;return r}
...
m.G=function(a){fd(this);var b=0,c=this.i,d=this,e=new $c;e.next=function(){if(c!=d.i)throw Error("The map has changed since the iterator was created");if(b>=d.f.length)throw Zc;var f=d.f[b++];return a?f:d.h[f]};
...
C(vd,F);vd.prototype.name="cancel";function N(a){L.call(this);this.l=1;this.i=[];this.j=0;this.f=[];this.h={};this.o=!!a}
...
m.m=function(){N.K.m.call(this);this.clear();this.i.length=0};function Hd(a){this.f=a}
...
Id.prototype.set=function(a,b){Id.K.set.call(this,a,Kd(b))};
Id.prototype.g=function(a){a=Id.K.get.call(this,a);if(!w(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
...
C(Ld,Id);Ld.prototype.set=function(a,b,c){if(b=Kd(b)){if(c){if(c<B()){Ld.prototype.remove.call(this,a);return}b.expiration=c}b.creation=B()}Ld.K.set.call(this,a,b)};
Ld.prototype.g=function(a){var b=Ld.K.g.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<B()||c&&c>B())Ld.prototype.remove.call(this,a);else return b}};function Md(){}
;function Nd(){}
...
return je(a,f||{},!1)}
function we(a,b){var c=P("CORS_HEADER_WHITELIST")||{},d=I(K(3,a));return d?(c=c[d])?0<=La(c,b):!1:!0}
...
return k}
;var He={},Ie=0;
function Je(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Ab,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof H||(a="object"==typeof a&&a.I?a.H():String(a),xb.test(a)||(a="about:invalid#zClosurez"),a=zb(a)),b=wb(a).toString(),"about:invalid#zClosurez"===b?a="":(b instanceof Db?a=b:(d="object"==typeof b,a=null,d&&b.ea&&(a=b.ba()),b=nb(d&&b.I?b.H():String(b)),a=Hb(b,a)),a=Fb(a).toString(),a=encodeURIComponent(String(hd(a)))),/^[\s\xa0]*$/.test(a)||(a=dc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+
...
function Ke(a,b){var c=Zd.EXPERIMENT_FLAGS;if(!c||!c.web_use_beacon_api_for_ad_click_server_pings)return!1;c=I(K(5,a));return c&&-1!=c.indexOf("/aclk")&&"1"===oc(a,"ae")&&"1"===oc(a,"act")?Me(a)?(b&&b(),!0):!1:!1}
...
window.console.log(c.join("\n"),e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Wb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Ca(window.yterr)&&window.yterr(a),Ne[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={Xa:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},F:{url:P("PAGE_NAME",window.location.href),
...
Sf.prototype.m=function(){window.clearInterval(this.J);Qf(this.C)};var Tf={};
function Uf(a){var b=void 0===a?{}:a;a=void 0===b.ya?!0:b.ya;b=void 0===b.Ma?!1:b.Ma;if(null==z("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?B()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&Vf();V(document,"keydown",Vf);V(document,"keyup",Vf);V(document,"mousedown",Vf);V(document,"mouseup",Vf);a&&(b?V(window,"touchmove",function(){Wf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Wf("resize",200)}),V(window,"scroll",function(){Wf("scroll",200)})));
...
function jg(a,b){var c=ag[a],d=hg[a]||{};hg[a]=d;var e=Math.round(U());for(l in W[a]){var f=bb,g=b.f;g={client:{hl:g.Fa,gl:g.Ea,clientName:g.Ca,clientVersion:g.Da,configInfo:g.Ba}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(g.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=lg(a,l);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=gg[l])a:{var k=
...
function pg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:Xf())};R("log_sequence_info_on_gel_web")&&d.O&&(a=e.context,b=d.O,og[b]=b in og?og[b]+1:0,a.sequence={index:og[b],groupKey:b},d.ob&&delete og[d.O]);(d=d.aa)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),gg[d.token]=a,d=lg("log_event",d.token)):d=lg("log_event");d.push(e);c&&(dg.log_event=new c);d.length>=(oe("web_logging_max_batch")||
100)?ig():kg()}
...
var sg=1;function tg(a,b,c){var d=ug;b={csn:a,parentVe:rg(b),childVes:Na(c,function(f){return rg(f)})};
c=q(c);for(var e=c.next();!e.done;e=c.next())e=rg(e.value),(Ya(e)||!e.trackingParams&&!e.veType)&&Pe(Error("Child VE logged with no data"),"WARNING");c={aa:void 0,O:a};"UNDEFINED_CSN"==a?vg("visualElementAttached",b,c):pg("visualElementAttached",b,d,c)}
function vg(a,b,c){a={sb:a,payload:b,options:c};(b=P("INTERACTIONS_LOGGER_QUEUE",void 0))?b.push(a):O("INTERACTIONS_LOGGER_QUEUE",[a])}
;function wg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.lb||P("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().kb:b=Bc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
;function yg(a,b,c,d){Vb.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)}
;function zg(){var a=new Pd;(a=a.isAvailable()?new Vd(a,"yt.innertube"):null)||(a=new Qd("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new Ld(a):null;this.g=document.domain||window.location.hostname}
zg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,B()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(hd(b))}catch(f){return}else e=escape(b);yg(a,e,c,this.g)};
zg.prototype.get=function(a,b){var c=void 0,d=!this.f;if(!d)try{c=this.f.get(a)}catch(e){d=!0}if(d&&(c=Vb.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
zg.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;Vb.remove(""+a,"/",void 0===b?"youtube.com":b)};var Ag=new zg;function Bg(a,b,c,d){if(d)return null;d=Ag.get("nextId",!0)||1;var e=Ag.get("requests",!0)||{};e[d]={method:a,request:b,authState:xg(c),requestTime:Math.round(U())};Ag.set("nextId",d+1,86400,!0);Ag.set("requests",e,86400,!0);return d}
function Cg(a){var b=Ag.get("requests",!0)||{};delete b[a];Ag.set("requests",b,86400,!0)}
function Dg(a){var b=Ag.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=xg(wg(!1));$a(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),mg(a,d.method,e,{}));delete b[c]}}Ag.set("requests",b,86400,!0)}}
;function ug(a){var b=this;this.f=a||{za:$d("INNERTUBE_API_KEY"),Aa:$d("INNERTUBE_API_VERSION"),Ba:P("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Ca:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),Da:$d("INNERTUBE_CONTEXT_CLIENT_VERSION"),Fa:$d("INNERTUBE_CONTEXT_HL"),Ea:$d("INNERTUBE_CONTEXT_GL"),Ga:$d("INNERTUBE_HOST_OVERRIDE")||"",Ha:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};rf(function(){Dg(b)},0,5E3)}
function mg(a,b,c,d){!P("VISITOR_DATA")&&.01>Math.random()&&Q(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",F:c,ma:"JSON",N:function(){d.N()},
la:d.N,onSuccess:function(v,p){if(d.onSuccess)d.onSuccess(p)},
ka:function(v){if(d.onSuccess)d.onSuccess(v)},
onError:function(v,p){if(d.onError)d.onError(p)},
rb:function(v){if(d.onError)d.onError(v)},
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ga;g&&(f=g);g=a.f.Ha||!1;var h=wg(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ie(""+f+("/youtubei/"+a.f.Aa+"/"+b),{alt:"json",key:a.f.za}),l;if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Bg(b,c,h,g))){var n=e.onSuccess,r=e.ka;e.onSuccess=function(v,p){Cg(l);n(v,p)};
c.ka=function(v,p){Cg(l);r(v,p)}}try{R("use_fetch_for_op_xhr")?ye(k,e):(e.method="POST",e.F||(e.F={}),Be(k,e))}catch(v){if("InvalidAccessError"==v)l&&(Cg(l),l=0),Q(Error("An extension is blocking network request."),"WARNING");
else throw v;}l&&rf(function(){Dg(a)},0,5E3)}
;var Eg=B().toString();
function Fg(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=B();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Eg)for(a=1,b=0;b<Eg.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Eg.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var Gg=z("ytLoggingTimeDocumentNonce_")||Fg();y("ytLoggingTimeDocumentNonce_",Gg,void 0);function Hg(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function Ig(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Jg(a){return P(Ig(void 0===a?0:a),void 0)}
y("yt_logging_screen.getRootVeType",Jg,void 0);function Kg(){var a=Jg(0),b;a?b=new qg({veType:a,youtubeData:void 0}):b=null;return b}
function Lg(a){a=void 0===a?0:a;var b=P(Hg(a));b||0!=a||(R("kevlar_client_side_screens")?b="UNDEFINED_CSN":b=P("EVENT_ID"));return b?b:null}
y("yt_logging_screen.getCurrentCsn",Lg,void 0);function Mg(a,b,c){c=void 0===c?0:c;if(a!==P(Hg(c))||b!==P(Ig(c)))O(Hg(c),a),O(Ig(c),b),0==c&&(b=function(){setTimeout(function(){a&&pg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Gg,clientScreenNonce:a},ug)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
y("yt_logging_screen.setCurrentScreen",Mg,void 0);function Ng(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(K(3,window.location.href));g&&f.push(g);g=I(K(3,d));if(0<=La(f,g)||!g&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(f=document.createElement("a"),Jb(f,d),d=f.href),d){g=d.match(jc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&(b.itct||b.ved)&&
(b.csn=b.csn||Lg()),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e="ST-"+Nb(d).toString(36),b=b?lc(b):"",yg(e,b,k||5))}else k="ST-"+Nb(d).toString(36),b=b?lc(b):"",yg(k,b,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var r=void 0===r?window:r;c=r.location;a=mc(a,l)+n;a=a instanceof H?a:yb(a);c.href=wb(a)}return!0}
;function Og(a){a=a||{};var b={enablejsapi:1},c={};this.url=a.url||"";this.args=a.args||ab(b);this.assets=a.assets||{};this.attrs=a.attrs||ab(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Og.prototype.clone=function(){var a=new Og,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=ab(c):a[b]=c}return a};function Pg(){L.call(this);this.f=[]}
t(Pg,L);Pg.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.mb)}L.prototype.m.call(this)};var Qg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Rg(a){a=a||"";if(window.spf){var b=a.match(Qg);spf.style.load(a,b?b[1]:"",void 0)}else Sg(a)}
function Sg(a){var b=Tg(a),c=document.getElementById(b),d=c&&Ue(c,"loaded");d||c&&!d||(c=Ug(a,b,function(){Ue(c,"loaded")||(Se(c),cf(b),S(Ia(df,b),0))}))}
...
function Tg(a){var b=document.createElement("A");a=zb(a);Jb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Nb(b)}
;function Vg(a,b){L.call(this);this.l=this.U=a;this.C=b;this.o=!1;this.api={};this.S=this.B=null;this.D=new N;Tc(this,Ia(Uc,this.D));this.i={};this.P=this.T=this.h=this.Z=this.f=null;this.J=!1;this.j=this.A=null;this.V={};this.qa=["onReady"];this.Y=null;this.ha=NaN;this.R={};Wg(this);this.W("WATCH_LATER_VIDEO_ADDED",this.Ja.bind(this));this.W("WATCH_LATER_VIDEO_REMOVED",this.Ka.bind(this));this.W("onAdAnnounce",this.sa.bind(this));this.ra=new Pg(this);Tc(this,Ia(Uc,this.ra))}
t(Vg,L);m=Vg.prototype;m.getId=function(){return this.C};
m.loadNewVideoConfig=function(a){if(!this.g){a instanceof Og||(a=new Og(a));this.Z=a;this.f=a.clone();this.h=this.f.attrs.id||this.h;"video-player"==this.h&&(this.h=this.C,this.f.attrs.id=this.C);this.l.id==this.h&&(this.h+="-player",this.f.attrs.id=this.h);this.f.args.enablejsapi="1";this.f.args.playerapiid=this.C;this.T||(this.T=Xg(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=vc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=
vc(Number(a)||a);Yg(this);this.o&&Zg(this)}};
...
function $g(a){var b=!0,c=ah(a);c&&a.f&&(a=a.f,b=Ue(c,"version")==a.assets.js);return b&&!!z("yt.player.Application.create")}
function Yg(a){if(!a.g&&!a.J){var b=$g(a);if(b&&"html5"==(ah(a)?"html5":null))a.P="html5",a.o||bh(a);else if(ch(a),a.P="html5",b&&a.j)a.U.appendChild(a.j),bh(a);else{a.f.loaded=!0;var c=!1;a.A=function(){c=!0;var d=a.f.clone();z("yt.player.Application.create")(a.U,d);bh(a)};
a.J=!0;b?a.A():(hf(a.f.assets.js,a.A),Rg(a.f.assets.css),dh(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function ah(a){var b=ac(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function bh(a){if(!a.g){var b=ah(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.J=!1,b.isNotServable&&b.isNotServable(a.f.args.video_id)||eh(a)):a.ha=S(function(){bh(a)},50)}}
function eh(a){Wg(a);a.o=!0;var b=ah(a);b.addEventListener&&(a.B=fh(a,b,"addEventListener"));b.removeEventListener&&(a.S=fh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=fh(a,b,e))}for(var f in a.i)a.B(f,a.i[f]);Zg(a);a.T&&a.T(a.api);a.D.L("onReady",a.api)}
function fh(a,b,c){var d=b[c];return function(){try{return a.Y=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.Y=e,fe(e))}}}
function Wg(a){a.o=!1;if(a.S)for(var b in a.i)a.S(b,a.i[b]);for(var c in a.R)T(parseInt(c,10));a.R={};a.B=null;a.S=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.W.bind(a);a.api.removeEventListener=a.Oa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.wa.bind(a);a.api.getPlayerType=a.xa.bind(a);a.api.getCurrentVideoConfig=a.va.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ia.bind(a)}
m.Ia=function(){return this.o};
m.W=function(a,b){var c=this,d=Xg(this,b);if(d){if(!(0<=La(this.qa,a)||this.i[a])){var e=gh(this,a);this.B&&this.B(a,e)}this.D.subscribe(a,d);"onReady"==a&&this.o&&S(function(){d(c.api)},0)}};
m.Oa=function(a,b){if(!this.g){var c=Xg(this,b);c&&Fd(this.D,a,c)}};
function Xg(a,b){var c=b;if("string"==typeof b){if(a.V[b])return a.V[b];c=function(){var d=z(b);d&&d.apply(u,arguments)};
a.V[b]=c}return c?c:null}
function gh(a,b){var c="ytPlayer"+b+a.C;a.i[b]=c;u[c]=function(d){var e=S(function(){if(!a.g){a.D.L(b,d);var f=a.R,g=String(e);g in f&&delete f[g]}},0);
Za(a.R,String(e))};
return c}
m.sa=function(a){cf("a11y-announce",a)};
m.Ja=function(a){cf("WATCH_LATER_VIDEO_ADDED",a)};
m.Ka=function(a){cf("WATCH_LATER_VIDEO_REMOVED",a)};
...
m.cancel=function(){this.A&&of(this.f.assets.js,this.A);T(this.ha);this.J=!1};
m.m=function(){ch(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){Q(b)}this.V=null;for(var a in this.i)u[this.i[a]]=null;this.Z=this.f=this.api=null;delete this.U;delete this.l;L.prototype.m.call(this)};
function dh(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var hh={},ih="player_uid_"+(1E9*Math.random()>>>0);function jh(a){var b="player";b=x(b)?ac(b):b;var c=ih+"_"+(b[Ea]||(b[Ea]=++Fa)),d=hh[c];if(d)return d.loadNewVideoConfig(a),d.api;d=new Vg(b,c);hh[c]=d;cf("player-added",d.api);Tc(d,Ia(kh,d));S(function(){d.loadNewVideoConfig(a)},0);
return d.api}
function kh(a){delete hh[a.getId()]}
;function lh(a,b,c){c=void 0===c?{}:c;var d=ug;P("ytLoggingEventsDefaultDisabled",!1)&&ug==ug&&(d=null);pg(a,b,d,c)}
;var mh=z("ytLoggingLatencyUsageStats_")||{};y("ytLoggingLatencyUsageStats_",mh,void 0);var nh=0;function oh(a){mh[a]=mh[a]||{count:0};var b=mh[a];b.count++;b.time=U();nh||(nh=rf(ph,0,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Pe(c,b)}return!0}return!1}
function ph(){var a=U(),b;for(b in mh)6E4<a-mh[b].time&&delete mh[b];nh=0}
...
wh.prototype.toString=function(){return this.topic};var xh=z("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.M;N.prototype.publish=N.prototype.L;N.prototype.clear=N.prototype.clear;y("ytPubsub2Pubsub2Instance",xh,void 0);y("ytPubsub2Pubsub2SubscribedKeys",z("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);y("ytPubsub2Pubsub2TopicToKeys",z("ytPubsub2Pubsub2TopicToKeys")||{},void 0);y("ytPubsub2Pubsub2IsAsync",z("ytPubsub2Pubsub2IsAsync")||{},void 0);
y("ytPubsub2Pubsub2SkipSubKey",null,void 0);function yh(a,b){var c=z("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
...
function Ah(){var a=zh(),b;for(b in a)tf(a[b]);O("TIMING_TICK_EXPIRATION",{})}
;function Bh(a,b){vh.call(this,1,arguments)}
t(Bh,vh);function Ch(a,b){vh.call(this,1,arguments)}
t(Ch,vh);var Dh=new wh("aft-recorded"),Eh=new wh("timing-sent");function Fh(){var a;(a=z("ytcsi.data_"))||(a={tick:{},info:{}},Ja("ytcsi.data_",a));return a}
function Gh(){var a=Fh().nonce;a||(a=Fg(),Fh().nonce=a);return a}
;function Hh(){var a=Fh();if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
...
"playerInfo.preloadType",Y.yt_ad_pr="prerollAllowed",Y.pa="previousAction",Y.yt_red="isRedSubscriber",Y.st="serverTimeMs",Y.aq="tvInfo.appQuality",Y.br_trs="tvInfo.bedrockTriggerState",Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y),Kh="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),
Lh="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),Mh={},Nh=(Mh.mver="MEASUREMENT_VERSION_",Mh.pis="PLAYER_INITIALIZED_STATE_",Mh.yt_pt="LATENCY_PLAYER_",Mh.pa="LATENCY_ACTION_",Mh.yt_vst="VIDEO_STREAM_TYPE_",Mh),Oh=!1;
function Ph(){Fh().info.yt_lt="hot_bg";if(Qh()){var a="hot_bg",b=Hh();(b.gelInfos?b.gelInfos:b).info_yt_lt=!0;if("yt_lt"in Jh){var c=Jh.yt_lt;0<=La(Lh,c)&&(a=!!a);"yt_lt"in Nh&&(a=Nh.yt_lt+a.toUpperCase());b={};c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];d[c[c.length-1]]=a;Qh()&&(a=Fh(),"gelInfo"in a||(a.gelInfo={}),qh(a.gelInfo,b),a=Gh(),c=Object.keys(b).join(""),oh("info_"+c+"_"+a)||(b.clientActionNonce=a,lh("latencyActionInfo",b)))}else 0<=La(Kh,"yt_lt")||(b=Error("Unknown label logged with GEL CSI"),
b.params="yt_lt",fe(b))}}
...
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function Sh(){return Fh().tick}
function Th(){var a=Sh(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Fh().info.yt_pvis}
function Qh(){return!!R("csi_on_gel")||!!Fh().useGel}
function Uh(){Ah();if(!Qh()){var a=Sh(),b=Fh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in Ih){var e=Na(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=P("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:P("TIMING_ACTION",void 0)};d=Ph.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=Rh();Th()&&"youtube"==e&&(Ph(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=Rf();h={};e=[];for(var k in a)"_"!=
k.charAt(0)&&(g=Math.round(a[k]-c),h[k]=g,e.push(k+"."+g));f.rt=e.join(",");(a=z("ytdebug.logTiming"))&&a(f,h);Vh(f,!!b.ap);yh(Eh,new Ch(h.aft+(d||0),void 0))}}
function Vh(a,b){if(R("debug_csi_data")){var c=z("yt.timing.csiData");c||(c=[],y("yt.timing.csiData",c,void 0));c.push({page:location.href,time:new Date,args:a})}c="";for(var d in a)c+="&"+d+"="+a[d];d="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var e=void 0===e?"":e;Me(d,e)||Je(d,void 0,void 0,void 0,e)}else Je(d);Ja("yt.timing.pingSent_",!0)}
;function Wh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function Xh(a,b,c){x(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Yh(a)}
function Yh(a,b,c){if(Da(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Zh(a,b,c,d){if(Da(a)&&!Aa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};x(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function $h(a){a=void 0===a?!1:a;L.call(this);this.f=new N(a);Tc(this,Ia(Uc,this.f))}
C($h,L);$h.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
$h.prototype.j=function(a,b){this.g||this.f.L.apply(this.f,arguments)};function ai(a,b,c){$h.call(this);this.h=a;this.i=b;this.l=c}
t(ai,$h);function bi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(hd(a),d.i))}}
ai.prototype.m=function(){this.i=this.h=null;$h.prototype.m.call(this)};function ci(a){L.call(this);this.f=a;this.f.subscribe("command",this.na,this);this.h={};this.j=!1}
t(ci,L);m=ci.prototype;m.start=function(){this.j||this.g||(this.j=!0,bi(this.f,"RECEIVING"))};
m.na=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":x(d.event)&&(a=d.event,a in this.h||(c=A(this.Qa,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":x(d.event)&&di(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=ei(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=fi(a,c))&&this.j&&!this.g&&bi(this.f,a,c))}}};
m.Qa=function(a,b){this.j&&!this.g&&bi(this.f,a,this.ca(a,b))};
m.ca=function(a,b){if(null!=b)return{value:b}};
function di(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.m=function(){var a=this.f;a.g||Fd(a.f,"command",this.na,this);this.f=null;for(var b in this.h)di(this,b);L.prototype.m.call(this)};function gi(a,b){ci.call(this,b);this.i=a;this.start()}
...
gi.prototype.ca=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return ci.prototype.ca.call(this,a,b)};
gi.prototype.m=function(){ci.prototype.m.call(this);delete this.i};function hi(a,b,c){L.call(this);var d=this;c=c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.A="*";this.i=c;this.sessionId=null;this.channel="widget";this.B=!!a;this.o=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h)&&x(e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.B&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
t(hi,L);hi.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.A)}catch(e){Q(e,"WARNING")}}};
hi.prototype.m=function(){window.removeEventListener("message",this.o);L.prototype.m.call(this)};function ii(){var a=this.g=new hi(!!P("WIDGET_ID_ENFORCE")),b=A(this.Na,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=ii.prototype;m.Na=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,ji(this,a)),this.j[a]=!0)):this.ja(a,b,c)};
m.ja=function(){};
function ji(a,b){return A(function(c){this.sendMessage(b,c)},a)}
m.addEventListener=function(){};
m.ua=function(){this.l=!0;this.sendMessage("initialDelivery",this.da());this.sendMessage("onReady");G(this.i,this.oa,this);this.i=[]};
m.da=function(){return null};
function ki(a,b){a.sendMessage("infoDelivery",b)}
m.oa=function(a){this.l?this.g.sendMessage(a):this.i.push(a)};
m.sendMessage=function(a,b){this.oa({event:a,info:void 0==b?null:b})};
m.dispose=function(){this.g=null};function li(a){ii.call(this);this.f=a;this.h=[];this.addEventListener("onReady",A(this.La,this));this.addEventListener("onVideoProgress",A(this.Ua,this));this.addEventListener("onVolumeChange",A(this.Va,this));this.addEventListener("onApiChange",A(this.Pa,this));this.addEventListener("onPlaybackQualityChange",A(this.Ra,this));this.addEventListener("onPlaybackRateChange",A(this.Sa,this));this.addEventListener("onStateChange",A(this.Ta,this));this.addEventListener("onWebglSettingsChanged",A(this.Wa,
this))}
t(li,ii);m=li.prototype;m.ja=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Wh(a)){var d=b;if(Da(d[0])&&!Aa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Yh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Xh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Zh.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Wh(a)&&ki(this,this.da())}};
...
m.Ra=function(a){ki(this,{playbackQuality:a})};
m.Sa=function(a){ki(this,{playbackRate:a})};
...
m.Va=function(){ki(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
m.Ua=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:B()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());ki(this,a)};
m.Wa=function(){var a={sphericalProperties:this.f.getSphericalProperties()};ki(this,a)};
m.dispose=function(){ii.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function mi(a,b,c){L.call(this);this.f=a;this.i=c;this.j=V(window,"message",A(this.l,this));this.h=new ai(this,a,b);Tc(this,Ia(Uc,this.h))}
...
mi.prototype.m=function(){Qf(this.j);this.f=null;L.prototype.m.call(this)};function ni(){var a=ab(oi),b;return ud(new M(function(c,d){a.onSuccess=function(e){re(e)?c(e):d(new pi("Request failed, status="+e.status,"net.badstatus",e))};
...
qi.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),nd(a)?a:ri(a)):2===this.g&&b?(a=b.call(c,this.f),nd(a)?a:si(a)):this};
...
;function ti(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof ui;this.isTimeout=a instanceof pi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof vd}
t(ti,F);ti.prototype.name="BiscottiError";function ui(){F.call(this,"Biscotti ID is missing from server")}
t(ui,F);ui.prototype.name="BiscottiMissingError";var oi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},vi=null;function ce(){if("1"===Va(ae(),"args","privembed"))return sd(Error("Biscotti ID is not available in private embed mode"));vi||(vi=ud(ni().then(wi),function(a){return xi(2,a)}));
return vi}
function wi(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new ui;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new ui;a=a.id;de(a);vi=ri(a);yi(18E5,2);return a}
function xi(a,b){var c=new ti(b);de("");vi=si(c);0<a&&yi(12E4,a-1);throw c;}
function yi(a,b){S(function(){ud(ni().then(wi,function(c){return xi(b,c)}),xa)},a)}
function zi(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ce()}catch(b){return sd(b)}}
;function Ai(a){if("1"!==Va(ae(),"args","privembed")){a&&be();try{zi().then(function(){},function(){}),S(Ai,18E5)}catch(b){Q(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Bi(){this.f=P("ALT_PREF_COOKIE_NAME","PREF");var a=Vb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
ya(Bi);var Fi=null,Gi=null,Hi=null,Ii={};function Ji(a){var b=a.id;a=a.ve_type;var c=sg++;a=new qg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Ii[b]=a;b=Lg();c=Kg();b&&c&&tg(b,c,[a])}
function Ki(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Mg(b,a),a=Kg()))for(var c in Ii){var d=Ii[c];d&&tg(b,a,[d])}}
function Li(a){Ii[a.id]=new qg({trackingParams:a.tracking_params})}
function Mi(a){var b=Lg(),c=Ii[a.id];if(b&&c){a=ug;c={csn:b,ve:rg(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={aa:void 0,O:b};"UNDEFINED_CSN"==b?vg("visualElementGestured",c,d):pg("visualElementGestured",c,a,d)}}
function Ni(a){a=a.ids;var b=Lg();if(b)for(var c=0;c<a.length;c++){var d=Ii[a[c]];if(d){var e=ug;d={csn:b,ve:rg(d),eventType:1};var f={aa:void 0,O:b};"UNDEFINED_CSN"==b?vg("visualElementShown",d,f):pg("visualElementShown",d,e,f)}}}
...
y("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Ai(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");Fi=a=jh(a);a.addEventListener("onScreenChanged",Ki);a.addEventListener("onLogClientVeCreated",Ji);a.addEventListener("onLogServerVeCreated",Li);a.addEventListener("onLogVeClicked",Mi);a.addEventListener("onLogVesShown",
Ni);b=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Hi=new li(a):P("ENABLE_POST_API")&&x(b)&&x(c)&&(Gi=new mi(window.parent,b,c),Hi=new gi(a,Gi.h));c=$d("BG_P");Gf(c)&&(P("BG_I")||P("BG_IU"))&&(Cf=!0,Bf.initialize(P("BG_I",null),P("BG_IU",null),c,Ff,void 0));wf()},void 0);
y("yt.www.watch.ads.restrictioncookie.spr",function(a){Je(a+"mac_204?action_fcts=1");return!0},void 0);
var Oi=ee(function(){var a=Sh(),b;(b=!R("use_first_tick"))||(b=!("ol"in Sh()));if(b){b="ol";X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b));b=Rf();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=zh();if(b=a.ol)tf(b),a.ol=0;a=Qh();b=Hh();b.gelTicks&&(b.gelTicks.tick_ol=!0);Rf();a?(a=Gh(),oh("tick_ol_"+a)||lh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!z("yt.timing.pingSent_");if(a&&(b=P("TIMING_ACTION",void 0),a=Sh(),z("ytglobal.timingready_")&&
b&&a._start&&(b=Rh()))){Oh||(yh(Dh,new Bh(Math.round(b-a._start),void 0)),Oh=!0);b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Uh()}}a=Bi.getInstance();c=!!((Ei("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Xc(document.body,"exp-invert-logo")&&(b&&!Xc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Xc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":
"inverted-hdpi")):!b&&Xc(document.body,"inverted-hdpi")&&Yc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Ei(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),Pi=ee(function(){var a=Fi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++)tf(uf[a]);uf.length=0;nf("//static.doubleclick.net/instream/ad_status.js");vf=!1;O("DCLKSTAT",0);Vc(Hi,Gi);if(a=Fi)a.removeEventListener("onScreenChanged",Ki),a.removeEventListener("onLogClientVeCreated",Ji),a.removeEventListener("onLogServerVeCreated",Li),a.removeEventListener("onLogVeClicked",Mi),a.removeEventListener("onLogVesShown",Ni),a.destroy();Ii={}});
window.addEventListener?(window.addEventListener("load",Oi),window.addEventListener("unload",Pi)):window.attachEvent&&(window.attachEvent("onload",Oi),window.attachEvent("onunload",Pi));Ja("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||Hf);Ja("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||If);Ja("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||xf);
Ja("yt.player.exports.navigate",z("yt.player.exports.navigate")||Ng);Ja("yt.util.activity.init",z("yt.util.activity.init")||Uf);Ja("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||Xf);Ja("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||Vf);}).call(this);
